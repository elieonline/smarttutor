@extends('layouts.app', ['class' => 'university-lp', 'title' => 'Register'])
@section('styles')
                            ...
                            <form class="text-center" style="color: #757575;" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="md-form mt-0 text-right">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" id="student" name="role" value="0">
                                        <label class="form-check-label" for="student">Student</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" id="tutor" name="role" value="1">
